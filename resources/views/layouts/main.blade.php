    ...
    <header class="edica-header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="index.html"><img src="{{ asset('images/logo.png') }}" alt="HalykSergeki"></a>
                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('main')}}">About</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="{{route('main')}}" id="blogDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Posts</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="{{route('main')}}" id="pagesDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Help</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#"><img src="{{asset('images/profile.png')}}" alt=""width="22px"height="22px"/></a>
                            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                                <a class="dropdown-item" href="{{route('create_post')}}"><img src="{{asset('images/add.png')}}" alt="" width="22px" height="22px"/></a>
                                <a class="dropdown-item" href="#"><img src="{{asset('images/bell.png')}}" alt="" width="22px" height="22px"/></a>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="row footer-widget-area">
                <div class="col-md-3">
                    <a href="{{ asset('index.html') }}" class="footer-brand-wrapper">
                        <img src="{{ asset('assets/images/logo.svg') }}" alt="halyksergeki logo">
                    </a>
                    <p class="contact-details">hello@halyksergeki.com</p>
